...
const Contact = () => {
    ...
    return (
       ...
       <Meta
        ...
        ogDescription="Lenodev - Contact"
        ogTitle="Contact - page"
        keywords="Liên hệ với Lenodev"
        twitterTitle="Lenodev - News"
        twitterDescription="Liên hệ "
      ...
      <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg leading-8 text-gray-600">Let's contact us now.</p>
        </div>
